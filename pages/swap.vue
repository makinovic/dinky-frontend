<template>
    <div class="container mt-5">
        ...
        <h5>Cambiar plan</h5><hr/>
                ...
                <template v-else>
                    <div>
                Actualmente no puedes cambiarte de plan, porque estás usando el plan con mayor capacidad y estás excediendo el uso de almacenamiento de planes inferiores. Por favor, elimina videos para pasar a otro plan.
...
<script>
 import AppPlan from "@/components/videos/AppPlan";
export default {
    head:{
    title:"Cambiar plan"
     },
    ...
    methods: {
       ...
       try{
        ...
        this.$auth.fetchUser();
        this.$router.replace({name:"panel-dashboard"});
       } catch(error){
